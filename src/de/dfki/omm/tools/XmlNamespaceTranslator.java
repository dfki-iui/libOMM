...
/** Tool to translate between namespace URIs. */
public class XmlNamespaceTranslator { // TODO This class and its nested classes are not used anywhere

    private Map<Key<String>, Value<String>> translations = new HashMap<Key<String>, Value<String>>();

    /** Add a namespace translation to the known translations.
     * @param fromNamespaceURI The URI for which to add a translation.
     * @param toNamespaceURI The translation.
     * @return The updated {@link XmlNamespaceTranslator} object. 
     */
    ...
    /** Translates namespace URIs in an XML Document to their known counterparts. 
     * @param xmlDoc The {@link document} in which to translate namespaces. 
     */
